...
export default function Footer() {
  return <footer>
    <Grid container spacing={3} style={{ justifyContent: 'center' }}>
      <Grid item xs={12}>
        <Typography variant="body2" style={{ textAlign: 'center' }}>Made with ❤ by
          <Link href="https://beacons.page/benthamite" target="_blank" rel="noopener noreferrer" > @benthamite</Link>
              {' • '}
